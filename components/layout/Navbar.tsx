      ...
      >
        {SITE_CONFIG.navItems.map((item) => (
          <Link
            key={item.href}
            href={item.href}
            className="group flex min-w-[3.85rem] flex-col items-center gap-1 rounded-full px-3 py-2 text-[0.62rem] font-bold uppercase tracking-[0.08em] text-muted transition-colors hover:bg-red hover:text-white focus-visible:sr-focus md:min-w-[4.8rem] md:flex-row md:justify-center"
            data-cursor="link"
          >
            <Icon icon={item.icon} />
