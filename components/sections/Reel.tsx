...
export function Reel(): JSX.Element {
  return (
    <section className="relative overflow-hidden bg-text py-24 text-white md:py-32" id="showreel">
      <h2 className="pointer-events-none absolute left-1/2 top-8 -translate-x-1/2 font-display text-[18vw] uppercase leading-none text-red/35">
        Reels
      </h2>
      <div className="section-shell relative z-10">
        <div className="mb-12 rotate-[-1.5deg]">
          <p className="font-ui text-xs font-black uppercase tracking-[0.22em] text-red">Social Media</p>
          <h2 className="font-display text-7xl uppercase leading-none text-white md:text-9xl">
        ...
        <SocialReelsGrid limit={4} variant="horizontal" />
      </div>
    </section>
  );
}
